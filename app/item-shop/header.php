...
<div class="navbar navbar-inverse navbar-static-top-top  navbar-fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="responsive-menu">
            ...
            <?php if ($_SESSION["login"] == "Guest") { ?><a class="navbar-brand" href='../../app/enter.php'>Click here
                to login</a><?php } ?>
            <?php if ($_SESSION["login"] !== "Guest") { ?><a class="navbar-brand" href='../../app/logout.php'>Click here
                to log out</a><?php } ?>
        </div>
